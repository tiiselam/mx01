...
--(SELECT TOP 1 TX.TXDTOTTX FROM SOP10105 TX WHERE TX.SOPTYPE = A.SOPTYPE AND TX.SOPNUMBE = A.SOPNUMBE
--AND TX.LNITMSEQ = 0 AND TXDTOTTX > 0 AND TAXDTLID LIKE 'V-IVA%') TAXAMNT, 
A.DOCAMNT, 
...
--(SELECT TOP 1 TX.TXDTOTTX FROM SOP10105 TX WHERE TX.SOPTYPE = A.SOPTYPE AND TX.SOPNUMBE = A.SOPNUMBE
--AND TX.LNITMSEQ = 0 AND TXDTOTTX > 0 AND TX.TAXDTLID LIKE 'V-IVA%')) CURTEXT, 
...
DYNAMICS.dbo.fncNUMLET(A.CURNCYID, A.SUBTOTAL-A.TRDISAMT+isnull(IMPU.STAXAMNT, 0)) CURTEXT,
--(SELECT TOP 1 TX.TXDTOTTX FROM SOP10105 TX WHERE TX.SOPTYPE = A.SOPTYPE AND TX.SOPNUMBE = A.SOPNUMBE
--AND TX.LNITMSEQ = 0 AND TXDTOTTX > 0 AND TX.TAXDTLID LIKE 'V-IVA%')
...
--------------------------------------------------------------------
--select *
--from [IMPRIME_COMPROBANTE_UNICO]
--where sopnumbe = 'FC 00000406'

--SELECT *	--sum(TX.STAXAMNT) STAXAMNT
--			FROM SOP10105 TX 
--			WHERE --TX.SOPTYPE = A.SOPTYPE 
--			 TX.SOPNUMBE ='FC 00000406'
--			AND TX.LNITMSEQ = 0 
--			AND TAXDTLID LIKE 'V-IVA%'
