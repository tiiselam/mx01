...
IF (@@Error = 0) PRINT 'Creación exitosa de la vista: vwRmCfdiFacturasConFolioFiscal'
ELSE PRINT 'Error en la creación de la vista: vwRmCfdiFacturasConFolioFiscal'
GO
